import { Workflow, Construction, LayoutDashboard, CheckSquare, Shield, Users } from "lucide-react";

export const features = [
  { icon: Workflow, title: "Smart Workflow Generation", description: "AI-powered workflow creation and optimization" },
  { icon: Construction, title: "Seamless Integration Hub", description: "Connect with your existing tools effortlessly" },
