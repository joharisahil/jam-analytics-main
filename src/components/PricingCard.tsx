...
const PricingCard: React.FC<PricingCardProps> = ({
  ...
  return (
    <div
      ...
      className={`relative flex flex-col justify-between mt-4 sm:mx-auto p-2 sm:p-4 rounded-3xl text-white text-left w-full max-w-sm min-h-[500px] overflow-hidden transition-all duration-100 ease-in-out transform hover:scale-110 ${
