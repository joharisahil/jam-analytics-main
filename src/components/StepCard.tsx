...
interface StepCardProps {
  ...
  title: string;
  description: string;
  stepNumber: number; // Step number for the badge
}
const StepCard: React.FC<StepCardProps> = ({
  ...
  return (
    <div
      className="relative text-center items-center border-2 border-gray-800 bg-gradient-to-b from-black via-[#1a0127] to-[#240137] rounded-xl p-6 shadow-lg"
      style={{
    ...
    >
      ...
      <div
        className="absolute top-3 left-3 w-7 h-7 flex items-center justify-center bg-gray-700 text-white text-sm font-semibold rounded-md z-20 backdrop-blur-lg"
        style={{
          background: "#3D3D3D66",
