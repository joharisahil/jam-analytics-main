const NavDown = () => {
  return (
    <div className="relative overflow-hidden flex items-center justify-center bg-[#0] pb-11 ">
      {/* <div className=""> */}
      {/* Background Circles */}
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, #361764 30%, #11081f 38%, #000000 90%)",
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, #2C1251 40%, #0C0318 48%, #000000 80%)",
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, #2C1251 25%, #0C0318 65%, #000000 80%)",
