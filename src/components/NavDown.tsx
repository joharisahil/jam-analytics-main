  ...
  return (
    <div className="relative overflow-hidden flex items-center justify-center bg-[#0] p-1">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, #361764 30%, #11081f 38%, #000000 100%)",
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, #2C1251 40%, #0C0318 50%, #000000 90%)",
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, #2C1251 15%, #0C0318 60%, #000000 90%)",
