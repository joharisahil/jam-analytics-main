  ...
  return (
    <div className="min-h-screen bg-[#0a060f] flex items-center justify-center relative overflow-hidden">
       <div 
        ...
        style={{
          background: "radial-gradient(circle,  #090909 70%, #ffffff 100%, #0A020F 100%)"
        }}
      ></div>
      {/* Largest Circle  */}
      <div 
        ...
        style={{
          background: "radial-gradient(circle, #0A020F 60%, #1E0935, #ffffff 85%, #A34DE0 20%)"
        }}
      ></div>
      ...
      <div 
        ...
        style={{
          background: "radial-gradient(circle, #1E0935 60%, #120424 65%, #000000 90%)"
        }}
      ></div>
      ...
      <div 
        ...
        style={{
          background: "radial-gradient(circle, #1E0935 25%, #120424 57%, #000000 85%)"
        }}
      ></div>
      ...
      <div 
        ...
        style={{
          background: "radial-gradient(circle, #1E0935 35%, #0C0318 50%, #000000 80%)"
        }}
      ></div>
